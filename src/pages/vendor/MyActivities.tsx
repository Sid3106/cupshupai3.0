    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col items-center text-center md:text-left md:flex-row md:justify-between md:items-center">
        <div className="w-full md:w-auto mb-4 md:mb-0">
          <h1 className="text-2xl font-semibold text-[#00A979] text-center md:text-left">My Activities</h1>
          ...
          <div className="md:hidden mt-6 space-y-4">
            {filteredActivities.length === 0 ? (
              <div className="text-center py-8">
                ...
                <h3 className="text-lg font-medium text-gray-900 mb-2">No activities assigned</h3>
                <p className="text-gray-600">You'll see your assigned activities here.</p>
              </div>
            ) : (
